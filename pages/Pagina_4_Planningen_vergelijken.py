...
f1.update_layout(title = 'Aantal DDs', title_x=0.45, xaxis_title = 'Datasets', yaxis_title = 'Aantal DDs')
f1.add_bar(y=[DD, DD1],x=[1,2], marker = dict(color = 'blue'), name = 'aantal DDs')
st.plotly_chart(f1)
