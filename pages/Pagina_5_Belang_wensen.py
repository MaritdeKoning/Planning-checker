...
st.subheader('Bepaal hier hoe belangerijk u de wensen vind op een schaal van 1 tot 10')

#alle eisen op een rijtje
st.markdown('<p style="font-family:sans-serif; color:black; font-size: 18px;">Wens 1: Aantal bussen die worden gebruikt.</p>', unsafe_allow_html=True)
st.session_state.belang_wens1 = st.number_input('Belang wens 1', min_value = 1, max_value = 10)
st.markdown('<p style="font-family:sans-serif; color:black; font-size: 18px;">Wens 2: Aantal DPRUs wat word gereden.</p>', unsafe_allow_html=True)
